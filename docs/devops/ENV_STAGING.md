...
> **Cập nhật**: 2026-06-08  
> **Repo**: [https://github.com/ndt2011/japan-product](https://github.com/ndt2011/japan-product) (branch `main`)  
...
| **API URL**             | [https://product-production-7e4e.up.railway.app](https://product-production-7e4e.up.railway.app)                       |
| **Health**              | [https://product-production-7e4e.up.railway.app/api/health](https://product-production-7e4e.up.railway.app/api/health) |
| **MySQL**               | Service `MySQL` trên Railway                                                                                           |
| **Redis**               | Service `Redis` trên Railway                                                                                           |
| **Vercel Project**      | `japan-product`                                                                                                        |
| **Vercel URL**          | [https://japan-product.vercel.app](https://japan-product.vercel.app)                                                   |
